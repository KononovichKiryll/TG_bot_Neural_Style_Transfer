...
# style_img_path = r'local\style.jpg'
# content_img_path = r'local\context.jpg'
# output_path = r'local\output.jpg'
...
class ModelRunning(Thread):
    ...
    # def run_model(style_img_path, content_img_path, output_path):
    def run(self):
        ...
        print('!!!!!!!!!!!!!!!!!!!style transfer is fineshed!!!!!!!!!!!!!!!!!!!!')
    ...
    async def send(self):
        with open(self.output_path, 'rb') as output_file:
            print('!!!!!!send photo!!!!!!!!')
            await bot.send_photo(self.message.chat.id,output_file)
